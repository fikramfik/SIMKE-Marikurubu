...
class Twarga(db.Model):
    ...
    nama = db.Column(db.String(50), nullable=False)
    ttl = db.Column(db.String(30), nullable=False)
    jk = db.Column(db.String(20), nullable=False)
    gd = db.Column(db.String(20), nullable=False)
    alamat = db.Column(db.String(100), nullable=False)
    agama = db.Column(db.String(30), nullable=False)
    email = db.Column(db.String(50), unique=True, nullable=False)
    notlp = db.Column(db.String(13), unique=True, nullable=False)
    sp = db.Column(db.String(20), nullable=False)
    pekerjaan = db.Column(db.String(50), nullable=False)
    kewarganegaraan = db.Column(db.String(20), nullable=False)
    foto = db.Column(db.String(30), nullable=False, default='default.jpg')
    password = db.Column(db.String(80), nullable=False)
